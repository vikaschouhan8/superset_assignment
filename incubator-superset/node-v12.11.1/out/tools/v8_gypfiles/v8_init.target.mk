...
$(builddir)/libv8_init.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/libv8_init.a: LIBS := $(LIBS)
$(builddir)/libv8_init.a: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/libv8_init.a: TOOLSET := $(TOOLSET)
$(builddir)/libv8_init.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(builddir)/libv8_init.a
# Add target alias
.PHONY: v8_init
v8_init: $(builddir)/libv8_init.a
