...
$(OBJS): | $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(builddir)/libv8_compiler.a


### Rules for final target.
$(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp: TOOLSET := $(TOOLSET)
$(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp: $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(builddir)/libv8_compiler.a FORCE_DO_CMD
	$(call do_cmd,touch)
