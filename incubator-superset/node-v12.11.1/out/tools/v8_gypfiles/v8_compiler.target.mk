...
$(builddir)/libv8_compiler.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/libv8_compiler.a: LIBS := $(LIBS)
$(builddir)/libv8_compiler.a: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/libv8_compiler.a: TOOLSET := $(TOOLSET)
$(builddir)/libv8_compiler.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(builddir)/libv8_compiler.a
# Add target alias
.PHONY: v8_compiler
v8_compiler: $(builddir)/libv8_compiler.a
