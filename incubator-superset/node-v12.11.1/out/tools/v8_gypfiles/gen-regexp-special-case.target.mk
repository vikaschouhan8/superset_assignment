...
$(OBJS): | $(builddir)/libv8_libbase.a $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/v8_gypfiles/v8_headers.stamp $(obj).target/tools/v8_gypfiles/v8_version.stamp $(builddir)/libicui18n.a $(builddir)/libicuucx.a $(obj).target/tools/icu/icu_implementation.stamp $(obj).target/tools/icu/icu_uconfig.stamp $(obj).target/tools/icu/icu_uconfig_target.stamp $(obj).target/tools/icu/icuuc.stamp $(builddir)/libicudata.a $(builddir)/libicustubdata.a
...
$(builddir)/gen-regexp-special-case: LD_INPUTS := $(OBJS) $(builddir)/libv8_libbase.a $(builddir)/libicui18n.a $(builddir)/libicuucx.a $(builddir)/libicudata.a $(builddir)/libicustubdata.a
$(builddir)/gen-regexp-special-case: TOOLSET := $(TOOLSET)
$(builddir)/gen-regexp-special-case: $(OBJS) $(builddir)/libv8_libbase.a $(builddir)/libicui18n.a $(builddir)/libicuucx.a $(builddir)/libicudata.a $(builddir)/libicustubdata.a FORCE_DO_CMD
	$(call do_cmd,link)
