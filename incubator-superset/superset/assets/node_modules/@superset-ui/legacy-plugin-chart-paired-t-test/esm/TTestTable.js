...
React.createElement(Td,{key:c,column:a,data:b.group[c]}))});return d.push(React.createElement(Td,{key:l+1,className:a.getPValueStatus(c),column:"pValue",data:j[c]})),d.push(React.createElement(Td,{key:l+2,className:a.getLiftStatus(c),column:"liftValue",data:h[c]})),d.push(React.createElement(Td,{key:l+3,className:a.getSignificance(c),column:"significant",data:a.getSignificance(c)})),React.createElement(Tr,{key:c,onClick:a.computeTTest.bind(a,c),className:c===g?"control":""},d)}),n=e.concat([{column:"pValue",sortFunction:function sortFunction(c,a){return"control"===c?-1:"control"===a?1:c>a?1:-1;// p-values ascending
