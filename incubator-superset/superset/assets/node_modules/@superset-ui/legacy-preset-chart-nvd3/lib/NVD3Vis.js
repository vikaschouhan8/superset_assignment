...
if(ga&&(ea&&ea.interactiveLayer&&ea.interactiveLayer.tooltip&&ea.interactiveLayer.tooltip.classes([(0,_utils.generateTooltipClassName)(ga)]),ea&&ea.tooltip&&ea.tooltip.classes([(0,_utils.generateTooltipClassName)(ga)])),u.datum(d).transition().duration(500).attr("width",ha).attr("height",z).call(ea),window.addEventListener("scroll",(0,_lodash.throttle)(function(){return(0,_utils.hideTooltips)(!1)},250)),D&&0<fa.length){// Formula annotations
