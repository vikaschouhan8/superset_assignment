...
if(ha&&(fa&&fa.interactiveLayer&&fa.interactiveLayer.tooltip&&fa.interactiveLayer.tooltip.classes([generateTooltipClassName(ha)]),fa&&fa.tooltip&&fa.tooltip.classes([generateTooltipClassName(ha)])),v.datum(d).transition().duration(500).attr("width",ia).attr("height",y).call(fa),window.addEventListener("scroll",throttle(function(){return hideTooltips(!1)},250)),A&&0<ga.length){// Formula annotations
