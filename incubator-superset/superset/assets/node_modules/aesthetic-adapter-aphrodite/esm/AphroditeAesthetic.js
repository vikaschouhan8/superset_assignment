...
import { StyleSheet as Aphrodite, flushToStyleTag } from 'aphrodite';
  ...
  function AphroditeAesthetic(extensions, options) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleProperty", function (ruleset, name, value) {
      if (name === 'animationName') {
        ruleset.addCompoundProperty(name, _this.syntax.injectKeyframes(value, _this.keyframes));
      } else if (name === 'fontFamily') {
        if (value.includes(ruleset.selector)) {
          ruleset.addProperty(name, value);
        } else {
          ruleset.addCompoundProperty(name, _this.syntax.injectFontFaces(value, _this.fontFaces));
        }
      } else {
        ruleset.addProperty(name, value);
      }
