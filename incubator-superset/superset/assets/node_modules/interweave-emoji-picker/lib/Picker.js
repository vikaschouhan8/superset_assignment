...
var _interweaveEmoji = _interopRequireDefault(require("interweave-emoji"));
...
var Picker = function (_React$PureComponent) {
  ...
  _proto.getActiveGroup = function getActiveGroup(hasCommon) {
    ...
    if (group === _constants.GROUP_KEY_COMMONLY_USED) {
      ...
      group = _constants.GROUP_KEY_SMILEYS_PEOPLE;
    }
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement(_withContext.Context.Provider, {
      value: context
...
_defineProperty(Picker, "propTypes", {
  ...
  blacklist: _propTypes.default.arrayOf(_propTypes.default.any),
...
var _default = (0, _interweaveEmoji.default)()(Picker);
