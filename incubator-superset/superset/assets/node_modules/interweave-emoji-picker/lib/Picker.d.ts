...
import { WithEmojiDataProps, CanonicalEmoji, Path } from 'interweave-emoji';
...
export declare type PickerUnifiedProps = PickerProps & WithEmojiDataProps;
export declare class Picker extends React.PureComponent<PickerUnifiedProps, PickerState> {
     ...
     */
    setUpdatedState(nextState: Partial<PickerState>): void;
    render(): JSX.Element;
}
declare const _default: React.ComponentType<PickerProps & import("interweave-emoji").WithEmojiDataWrapperProps>;
