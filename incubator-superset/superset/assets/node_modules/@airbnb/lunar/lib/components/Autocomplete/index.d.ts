...
declare function getItemValue(item: any): string;
declare function renderItem(item: any): NonNullable<React.ReactNode>;
...
export declare type Props<T extends Item> = Omit<BaseInputProps, 'id'> & FormFieldProps & {
    /** Accessibility label. */
...
export declare type State<T extends Item> = {
    error: Error | null;
...
export default class Autocomplete<T extends Item> extends React.Component<Props<T>, State<T>> {
    ...
    loadItems: (value: string, force?: boolean, callback?: (() => void) | undefined) => Promise<void | T[]>;
    ...
    renderItem: (item: T, highlighted?: boolean, selected?: boolean, props?: React.HTMLAttributes<HTMLDivElement> | undefined) => JSX.Element;
