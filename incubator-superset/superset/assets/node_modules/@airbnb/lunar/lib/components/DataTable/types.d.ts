...
export declare type EditCallback<T = RowData> = (row: VirtualRow<T>, key: string, newVal: any, event: React.SyntheticEvent<EventTarget>) => void;
...
export declare type Renderer = React.ComponentType<RendererProps>;
