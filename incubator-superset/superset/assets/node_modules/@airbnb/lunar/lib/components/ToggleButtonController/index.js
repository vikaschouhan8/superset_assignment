...
class ToggleButtonController extends _react.default.Component {
  constructor() {
    super(...arguments);
    ...
    _defineProperty(this, "renderButton", (0, _proxyComponent.default)(_Button.default, (_ref) => {
      let {
        children,
        value
      } = _ref,
      ...
      return _react.default.createElement(_FormInputButton.default, _extends({}, props, {
        id: id + "-" + value,
        name: name,
        value: value,
        disabled: disabled,
...
exports.default = ToggleButtonController;
