...
function ZoomControls(props) {
  ...
  const handleZoomOut = (0, _react.useCallback)(() => onScale(scale - ZOOM_FACTOR < 1 ? 1 : scale - ZOOM_FACTOR), [scale]);
  const handleZoomIn = (0, _react.useCallback)(() => onScale(scale + ZOOM_FACTOR), [scale]);
