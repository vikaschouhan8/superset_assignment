...
class BaseSwitch extends _react.default.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    const _this$props = this.props,
      ...
      styles
          ...
          restProps = _objectWithoutPropertiesLoose(_this$props, ["cx", "checked", "disabled", "id", "invalid", "styles"]);
...
_defineProperty(BaseSwitch, "propTypes", {
  checked: _propTypes.default.bool,
  id: _propTypes.default.string.isRequired,
  onChange: _propTypes.default.func.isRequired
});

_defineProperty(BaseSwitch, "defaultProps", {
  checked: false
});
