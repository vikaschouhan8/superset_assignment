...
function sortList(list, keys, sortBy, sortDirection) {
  if (sortBy && keys.includes(sortBy)) {
    if (sortDirection === _reactVirtualized.SortDirection.ASC) {
...
function sortData(list, keys, selectedRows, selectedRowsFirst, sortBy, sortDirection) {
