...
export declare type Props = Omit<BaseInputProps, 'id' | 'onChange' | 'value'> & FormFieldProps & {
    ...
    onChange: (value: string, date: Date | null, event: React.ChangeEvent<HTMLInputElement>) => void;
...
export default class DatePickerInput extends React.Component<Props, State> {
    ...
    getFormat(): string;
    parseDate: (value: string, format?: string | undefined, locale?: any) => Date | undefined;
    formatDate: (date: string | Date, baseFormat?: string | undefined, locale?: any) => string;
    render(): JSX.Element;
}
