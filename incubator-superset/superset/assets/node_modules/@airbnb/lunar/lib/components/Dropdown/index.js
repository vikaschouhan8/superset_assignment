...
const PositionShape = _propTypes.default.oneOfType([_propTypes.default.number.isRequired, _propTypes.default.string.isRequired]);

const leftRightProp = (0, _airbnbPropTypes.mutuallyExclusiveProps)(PositionShape, 'left', 'right');
const topBottomProp = (0, _airbnbPropTypes.mutuallyExclusiveProps)(PositionShape, 'top', 'bottom');
  ...
  render() {
    const _this$props = this.props,
      ...
      zIndex
          ...
          props = _objectWithoutPropertiesLoose(_this$props, ["cx", "children", "fixed", "onBlur", "onFocus", "tabIndex", "zIndex", "visible", "onClickOutside"]);
