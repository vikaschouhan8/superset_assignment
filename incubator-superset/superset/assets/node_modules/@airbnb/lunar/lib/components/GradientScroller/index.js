...
exports.default = exports.GradientScroller = void 0;
...
class GradientScroller extends _react.default.Component {
  constructor(props) {
    ...
    _defineProperty(this, "handleResizeDebounced", (0, _debounce.default)(this.handleResize, 150));
    ...
    _defineProperty(this, "handleScrollThrottled", (0, _throttle.default)(this.handleScroll, 100));
  ...
  render() {
    ...
    }, showArrows ? _react.default.createElement("button", {
...
exports.GradientScroller = GradientScroller;

_defineProperty(GradientScroller, "propTypes", {
  autoScrollIncrement: _propTypes.default.number,
  children: _propTypes.default.node,
  hideScrollbar: _propTypes.default.bool,
