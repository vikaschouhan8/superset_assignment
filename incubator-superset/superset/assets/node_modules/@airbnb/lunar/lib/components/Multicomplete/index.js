...
var _Chip = _interopRequireDefault(require("./private/Chip"));
...
class Multicomplete extends _react.default.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return _react.default.createElement(_Autocomplete.default, _extends({
      ...
      value: ""
    }), selected.length > 0 && _react.default.createElement("div", null, selected.map(item => _react.default.createElement(_Spacing.default, {
      inline: true,
      key: item,
      right: 1,
      top: 1
