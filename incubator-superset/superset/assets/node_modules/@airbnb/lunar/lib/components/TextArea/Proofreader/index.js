...
exports.default = exports.Proofreader = void 0;
...
var _SecondaryMark = _interopRequireDefault(require("./SecondaryMark"));

var _ErrorMenu = _interopRequireDefault(require("./ErrorMenu"));

var _LocaleMenu = _interopRequireDefault(require("./LocaleMenu"));
...
const ARROW_KEYS = [_keys.ARROW_LEFT, _keys.ARROW_UP, _keys.ARROW_DOWN, _keys.ARROW_RIGHT];
...
class Proofreader extends _react.default.Component {
  constructor() {
    super(...arguments);

    _defineProperty(this, "caretRef", _react.default.createRef());

    _defineProperty(this, "controlsRef", _react.default.createRef());

    _defineProperty(this, "shadowRef", _react.default.createRef());

    _defineProperty(this, "textareaRef", _react.default.createRef());
    ...
    _defineProperty(this, "checkTextDebounced", (0, _debounce.default)(this.checkText, 2000, {
      leading: true
    }));
    ...
    _defineProperty(this, "handleReplaceText", (error, replacement) => {
      ...
      if (this.props.onChange) {
        ...
        this.props.onChange(newText, event);
      }
    });
  ...
  checkForAirbnbErrors(text) {
    ...
    while (match) {
      if (match[0] !== 'Airbnb') {
        customErrors.push({
          short_message: '',
          message: _Translate.default.phrase('Improper company spelling or casing', {}, {
  ...
  getLocaleDefinition(locale) {
    if (locale === NO_LOCALE) {
      return {
        locale,
        label: _Translate.default.phrase('No language selected', {}, {
    ...
    if (locale === AUTO_DETECT_LOCALE) {
      return {
        locale,
        label: _Translate.default.phrase('Auto-detect language', {}, {
    ...
    return _constants.LT_LOCALES.find(definition => definition.locale === locale);
  }
  ...
  selectAppropriateLocale() {
    ...
    if (locale === NO_LOCALE) {
      ...
      _constants.LT_LOCALES.some(definition => {
  ...
  renderTextWithMarks() {
    ...
    errors.forEach(error => {
      ...
      const MarkComponent = this.props.isRuleSecondary(error) ? _SecondaryMark.default : _Mark.default;
      content.push(_react.default.createElement(MarkComponent, {
        key: word + "-" + offset,
  ...
  render() {
    ...
    return _react.default.createElement("div", {
    ...
    }, _react.default.createElement("div", highlightsProps, this.renderTextWithMarks()), caretPosition > 0 && _react.default.createElement("div", {
      className: cx(styles.caret),
      ref: this.caretRef
    }, _react.default.createElement("span", null, text.slice(0, caretPosition)), _react.default.createElement("span", null, text.slice(caretPosition), ".")), _react.default.createElement(_BaseTextArea.default, _extends({}, props, {
      spellCheck: false,
      ...
      important: important
    })), position && selectedError && _react.default.createElement(_Dropdown.default, _extends({}, position, {
      zIndex: 5
    }), _react.default.createElement(_ErrorMenu.default, {
      error: selectedError,
    ...
    }, selectedLocale ? this.getLocaleDefinition(selectedLocale).label : _react.default.createElement(_Translate.default, {
    ...
    })), showLocaleMenu && _react.default.createElement(_Dropdown.default, {
      visible: true,
      top: "80%",
      left: theme.unit,
      zIndex: 5,
      onClickOutside: this.handleToggleLocaleMenu
    }, _react.default.createElement(_LocaleMenu.default // autoDefinition={this.getLocaleDefinition(AUTO_DETECT_LOCALE)}
    , {
      noneDefinition: this.getLocaleDefinition(NO_LOCALE),
      selectedLocale: selectedLocale,
      onSelectLocale: this.handleSelectLocale
    }))), errors.length > 0 && _react.default.createElement("span", {
      className: cx(styles.cell)
...
exports.Proofreader = Proofreader;
...
_defineProperty(Proofreader, "propTypes", {
  ...
  onCheckText: _propTypes.default.func.isRequired,
