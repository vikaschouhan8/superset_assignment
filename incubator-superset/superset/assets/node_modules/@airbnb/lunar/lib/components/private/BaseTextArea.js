...
var _passThroughRef = _interopRequireDefault(require("../../utils/passThroughRef"));
...
class BaseTextArea extends _react.default.Component {
  constructor() {
    super(...arguments);
    ...
    _defineProperty(this, "loadRef", ref => {
      ...
      (0, _passThroughRef.default)(this.props.propagateRef, ref);
    });
  }
  ...
  render() {
    ...
    return _react.default.createElement(_FormInput.default, _extends({}, restProps, {
