...
export function getErrorMessage(error, includeCode) {
  ...
  const message = debug ? debug.error_class + " - " + (debug.error_message || debug.response_message) : error.user_message || error.error_details || error.error_message || error.message;
