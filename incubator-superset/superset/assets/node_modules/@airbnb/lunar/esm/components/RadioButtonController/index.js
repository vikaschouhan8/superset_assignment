...
export default class RadioButtonController extends React.Component {
  constructor() {
    ...
    _defineProperty(this, "renderRadioButton", proxyComponent(RadioButton, (_ref) => {
      let {
        value
      } = _ref,
...
_defineProperty(RadioButtonController, "propTypes", {
...
_defineProperty(RadioButtonController, "defaultProps", {
  value: ''
});